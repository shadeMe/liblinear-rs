...
extern "C" {
	...
	pub fn cross_validation(prob: *const Problem, param: *const Parameter, nr_fold: i32, target: *mut f64);
	pub fn find_parameter_C(prob: *const Problem, param: *const Parameter, nr_fold: i32, start_C: f64, max_C: f64, best_C: *mut f64, best_rate: *mut f64);

	pub fn predict_values(model_: *const Model, x: *const FeatureNode, dec_values: *mut f64) -> f64;
	pub fn predict(model_: *const Model, x: *const FeatureNode) -> f64;
	pub fn predict_probability(model_: *const Model, x: *const FeatureNode, prob_estimates: *mut f64);
